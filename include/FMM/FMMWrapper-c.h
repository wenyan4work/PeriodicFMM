...
FMM_Wrapper *create_fmm_wrapper(int mult_order, int max_pts, int init_depth, int pbc, int regularize);
...
void FMM_UpdateTree(FMM_Wrapper *fmm, const double *trg_coor, const double *src_coord, const int num_trg,
                    const int num_src);
